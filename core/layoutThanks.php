...
<html lang="en">
    ...
    <head>
       <meta charset="UTF-8">
       <?php if(!empty($metal['Business and brothers'])): ?>
           <title><?php echo $metal[$title];?></title>
        <?php endif;?>
         <?php if(!empty($metal['business brothers'])): ?>
         <meta name="description" content="<?php echo $meta['description']; ?>">
        <?php endif;?>
        <?php if(!empty($metal['business, education, innovation'])): ?>
		...
		<body class="w3-light-gray w3-animate-opacity">
		<!-- Navbar (sit on top) -->
			<div class="w3-top w3-white w3-padding">
			
				<div class="w3-bar w3-white w3-theme-d2" id="myNavbar">
					...
					<!--<a href="" onclick="logout()" class="w3-bar-item w3-button w3-hide-small"> Logout</a> -->
			
				</div>

				 <!-- Navbar on small screens -->
				<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-white w3-hide w3-hide-large w3-hide-medium">
...
<footer class="w3-center w3-white w3-padding-16">
  ...
  <a href="index.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Top</a>
